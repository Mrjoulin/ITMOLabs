...
def show_equation_graphs(equation_ind):
    show_functions_graph(
        {
            "f(x)": EQUATIONS[equation_ind],
            "df/dx": EQUATIONS_DERIVATIVES[equation_ind],
            "d²f/dx²": EQUATIONS_SECOND_DERIVATIVES[equation_ind]
        }
    )
